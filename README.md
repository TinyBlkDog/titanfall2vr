...
Version **`v0.1.0`**. This is an alpha. Single player only; see
...
- Controllers are presented to the game as a gamepad, so in-game controller
  bindings apply. Snap and smooth turning, turn response curve, per-stick
  deadzones, three crouch modes, haptics.
...
- In-headset settings panel. 69 settings in 8 categories, saved on change.
...
`v0.1.0`, `titanfall2vr.dll` — SHA-256
`821525578a576a156b35a7c886bad23a64fc7f8c522ae1b4d89cc04092a8400a`
...
- the **version**, which the log prints at startup as
  `titanfall2vr v0.1.0 (<commit>) initialized`, with the build date and the
