...
QUEST 3 USERS, OPTIONAL. The very first launch with a new
headset looks badly magnified for about a minute while the mod
works out your panel geometry. If you are on a Quest 3 through
Virtual Desktop, copy optional	itanfall2vr.headset.cache into
the plugins folder as well and it will skip that.

It is ignored unless it matches your headset exactly, including
the resolution your Virtual Desktop quality setting asks for --
so if it does not match, nothing happens and nothing breaks.
Delete the file at any time to forget it.
...
project page. CONTROLS covers the whole controller map, all 72
